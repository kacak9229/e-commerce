...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        m2m_table_name = db.shorten_name(u'cart_cart_products')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('cart', models.ForeignKey(orm[u'cart.cart'], null=False)),
            ('products', models.ForeignKey(orm[u'products.products'], null=False))
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'cart_cart_products'))
    ...
    models = {
        ...
        u'cart.cart': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'products': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['products.Products']", 'null': 'True', 'blank': 'True'}),
